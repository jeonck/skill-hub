...
91 skills, one glyph each. Click any name for its install command.
...
| <img src="assets/icons/grill-me.svg" width="22" alt=""> | [**Grill Me**](https://github.com/RobMitt/grill-me-skill)<br>`grill-me` — link only, not mirrored | Interrogates you one question at a time until a plan or design is fully pinned down — walks each branch of the decision tree, surfacing assumptions and unmade decisions via multiple-choice prompts. A planning stress-test, not a code reviewer. |
