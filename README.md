...
| <img src="assets/icons/eli5.svg" width="22" alt=""> | [**ELI5**](https://skill.metacog.co.kr/s/eli5/)<br>`eli5` | Explain any topic, code, concept or error to a named audience — a five-year-old, a manager, a parent, a new engineer — matching vocabulary, analogies and depth to who is actually listening. Triggers on "explain like I'm…", "dumb it down", "how do I tell my boss…". |
| <img src="assets/icons/fire-your-seo-agency.svg" width="22" alt=""> | [**Fire Your SEO Agency**](https://skill.metacog.co.kr/s/fire-your-seo-agency/)<br>`fire-your-seo-agency` | Audit and optimise a site across five lanes — SEO, AEO, GEO, LLMO and NEO (Naver) — so it becomes a primary source that search, answer engines, generative AI and Naver's AI briefing cite. Diagnose → implement → measure, with a crawler's-eye check (what the HTML shows without JS), a no-black-hat rule, and a blog/content pipeline. Bilingual references. |
| <img src="assets/icons/humanize-korean.svg" width="22" alt=""> | [**Humanize Korean**](https://skill.metacog.co.kr/s/humanize-korean/)<br>`humanize-korean` | Rewrite Korean text that reads as AI-written — translationese, over-quoted English, mechanical parallelism, passive overuse, uniform rhythm, emoji and bullet excess — across 10 categories of tells, changing style and rhythm without touching the content. Routes to 1, 2 or 3+ passes by severity. |
...
| <img src="assets/icons/animate.svg" width="22" alt=""> | [**Animate**](https://skill.metacog.co.kr/s/animate/)<br>`animate` | Build a web animation from scratch by making the decisions in the order that settles whether it feels right — whether to animate at all, which tool, which properties, which curve, how it interrupts and exits — then write the implementation. |
| <img src="assets/icons/animate-expo.svg" width="22" alt=""> | [**Animate in Expo**](https://skill.metacog.co.kr/s/animate-expo/)<br>`animate-expo` | The same animation decision order for React Native and Expo — which thread it runs on, spring or timing, how the gesture hands off, how it degrades — implemented with Reanimated, Gesture Handler, Expo Router and expo-haptics. |
| <img src="assets/icons/animation-vocabulary.svg" width="22" alt=""> | [**Animation Vocabulary**](https://skill.metacog.co.kr/s/animation-vocabulary/)<br>`animation-vocabulary` | Reverse-lookup glossary that turns a vague description of a motion effect into its exact term — "the bouncy thing when a popover opens" becomes Pop in, "the iOS rubber-band scroll" becomes Rubber-banding. |
| <img src="assets/icons/anti-ui-slop.svg" width="22" alt=""> | [**Anti UI Slop**](https://skill.metacog.co.kr/s/anti-ui-slop/)<br>`anti-ui-slop` | Stop coding agents from shipping generic UI — ground interfaces in UIZZE's library of 800k+ real web and iOS screens, define a design contract, cover required states, and run a hard pre-ship finish gate. Works in Claude Code, Cursor, Copilot, Codex. |
| <img src="assets/icons/apple-design.svg" width="22" alt=""> | [**Apple Design for the Web**](https://skill.metacog.co.kr/s/apple-design/)<br>`apple-design` | Apple's approach to interface design and fluid, physical motion translated for the web — gesture-driven UI, spring and interruptible transitions, translucent materials and depth, optical typography, reduced-motion. |
| <img src="assets/icons/awesome-design-skills.svg" width="22" alt=""> | [**Awesome Design Skills**](https://github.com/bergside/awesome-design-skills)<br>`awesome-design-skills` — link only, not mirrored | A curated collection of 67 DESIGN.md / SKILL.md design systems — minimalism, brutalism, glassmorphism, luxury, dashboards and more — each with WCAG 2.2 AA typography, colour and spacing so agents ship magazine-grade layouts. |
...
| <img src="assets/icons/emil-design-eng.svg" width="22" alt=""> | [**Emil's Design Engineering**](https://skill.metacog.co.kr/s/emil-design-eng/)<br>`emil-design-eng` | Emil Kowalski's philosophy on UI polish, component design, animation decisions and the invisible details that make software feel finished. |
| <img src="assets/icons/find-animation-opportunities.svg" width="22" alt=""> | [**Find Animation Opportunities**](https://skill.metacog.co.kr/s/find-animation-opportunities/)<br>`find-animation-opportunities` | Search a codebase or UI for the places that don't animate but should, and reject everything that shouldn't. Read-only — it proposes motion with exact values rather than implementing it. |
...
| <img src="assets/icons/img2threejs.svg" width="22" alt=""> | [**img2threejs**](https://skill.metacog.co.kr/s/img2threejs/)<br>`img2threejs` | Turn one reference image into an animation-ready, procedural Three.js model built entirely in code — staged, quality-gated generation for object rebuilds and stylized characters, rendered live in the browser and orbitable by mouse. No 3D modeller needed. |
| <img src="assets/icons/impeccable.svg" width="22" alt=""> | [**Impeccable**](https://skill.metacog.co.kr/s/impeccable/)<br>`impeccable` | A design language that pulls agent UI out of default-SaaS territory (Inter, purple-blue gradients) — 23 named commands like /critique and /colorize plus automatic checks, so you steer toward a real brand look with explicit instructions instead of "make it nicer". |
| <img src="assets/icons/improve-animations.svg" width="22" alt=""> | [**Improve Animations**](https://skill.metacog.co.kr/s/improve-animations/)<br>`improve-animations` | Survey a codebase's motion code as a senior motion advisor and produce a prioritised audit plus self-contained implementation plans other agents can execute. Read-only on source — it plans the fixes, it doesn't apply them. |
...
| <img src="assets/icons/prototype.svg" width="22" alt=""> | [**Prototype Variants**](https://skill.metacog.co.kr/s/prototype/)<br>`prototype` | Build several genuinely different versions of a UI piece behind a visual picker, so you can flip through them live and promote the one that feels right. Explicit invocation only. |
...
| <img src="assets/icons/review-animations.svg" width="22" alt=""> | [**Review Animations**](https://skill.metacog.co.kr/s/review-animations/)<br>`review-animations` | Review motion code against a high craft bar drawn from Emil Kowalski's design engineering standards. Defaults to flagging — approval is earned. |
...
| <img src="assets/icons/ask-sonner.svg" width="22" alt=""> | [**Ask Sonner**](https://skill.metacog.co.kr/s/ask-sonner/)<br>`ask-sonner` | Working guide to Sonner, the React toast library — wiring the Toaster, picking the right toast() call, promise and loading toasts, styling and theming, and the failures people actually hit: toasts that never appear, appear twice, lose Tailwind classes or sit behind a modal. |
...
| <img src="assets/icons/browser-skill.svg" width="22" alt=""> | [**BrowserSkill**](https://skill.metacog.co.kr/s/browser-skill/)<br>`browser-skill` | Drive the user's real, logged-in Chromium from an agent — work happens in a separate Agent Window, user tabs must be explicitly borrowed, and sessions you are already signed into just work. Needs the bsk CLI and browser extension installed first. |
...
| <img src="assets/icons/find-skills.svg" width="22" alt=""> | [**Find Skills**](https://skill.metacog.co.kr/s/find-skills/)<br>`find-skills` | Vercel's official skill-discovery helper — when you ask "is there a skill for X" or "how do I do Y", it finds and installs matching agent skills via the open `npx skills` tool. |
...
| <img src="assets/icons/open-code-review.svg" width="22" alt=""> | [**Open Code Review**](https://skill.metacog.co.kr/s/open-code-review/)<br>`open-code-review` | Run Alibaba's `ocr` CLI over a diff, commit, branch comparison or whole file and get line-level review comments — a deterministic pipeline picks files and matches rules, then an LLM agent reads the surrounding code. Needs its own model endpoint configured. |
| <img src="assets/icons/open-code-review-delegate.svg" width="22" alt=""> | [**Open Code Review (Delegate)**](https://skill.metacog.co.kr/s/open-code-review-delegate/)<br>`open-code-review-delegate` | The same review engine with no LLM endpoint to configure — `ocr` does only the deterministic part, file selection and rule resolution, and hands the reviewing to the agent already in the session. The way to use Alibaba's rulesets without a second API key. |
| <img src="assets/icons/pick-ui-library.svg" width="22" alt=""> | [**Pick a UI Library**](https://skill.metacog.co.kr/s/pick-ui-library/)<br>`pick-ui-library` | Pick the right frontend library for the task from a curated, opinionated list — numbers, OTP inputs, charts, command menus, virtualization, drag and drop, toasts, state and styling. Explicit invocation only. |
...
| <img src="assets/icons/omnivoice.svg" width="22" alt=""> | [**OmniVoice TTS**](https://skill.metacog.co.kr/s/omnivoice/)<br>`omnivoice` | Synthesise speech in 600+ languages with OmniVoice — clone a voice from a reference clip, design one from a written description, or let the model pick — driven through its CLI, JSONL batch runner or Python API. |
